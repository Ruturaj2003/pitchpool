...
import { getCommentsByPitchId } from "../../_data/firebaseService";
...
export default function Comments() {
  ...
  useEffect(() => {
    async function fetchComments() {
      const res = await getCommentsByPitchId(pitchId);
      setComments(res);
    }
    if (pitchId) fetchComments();
  }, [pitchId]);
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="text-center mb-12 animate-fade-in">
          ...
          <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
            Review comments from investors who've seen your pitch. Connect with
            sharks for mentoring and partnership opportunities to take your
      ...
      <footer className="w-full border-t border-gray-100 dark:border-gray-800 py-8 mt-12 bg-white/50 dark:bg-gray-900/50 backdrop-blur-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6">
            <a
              href="#"
              className="text-gray-500 hover:text-shark-purple transition-colors"
            >
              Terms
            </a>
            <a
